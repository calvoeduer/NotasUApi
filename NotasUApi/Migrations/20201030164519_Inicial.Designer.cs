...
namespace NotasUApi.Migrations
{
    ...
    [Migration("20201030164519_Inicial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NotasUApi.Model.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("varchar(767)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("NotasUApi.Model.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("NotasUApi.Model.Subject", b =>
                {
                    b.HasOne("NotasUApi.Model.ApplicationUser", "User")
                        .WithMany("Subjects")
                        .HasForeignKey("UserId");
                });
